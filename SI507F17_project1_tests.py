...
# If you have correctly written the tests, at least 3
# tests should fail. If more than 3 tests fail, it should
# be because multiple of the test methods address the same
# problem in the code.
# You may write as many TestSuite subclasses as you like,
# but you should try to make these tests well-organized and
# easy to read the output.
# You should invoke the tests with verbosity=2
# (make sure you invoke them!)
...
# 6. Test to see if pop_card() method is able to pop
# all 52 cards off of a fresh deck
...
# 12. Test to see if show_song returns the same value
# for the same search parameter
